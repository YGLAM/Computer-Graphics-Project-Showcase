...
var lights = {
    ...
    setLightValues: function (obj) {
        ...
        // Helper Variables
        var lightLoc = obj.drawInfo.lightLocation;
        gl.uniform1f(lightLoc.lightType, typeToInt(lightsInfo[bID].lightType));
        gl.uniform1f(lightLoc.lightAmbientType, typeToInt(lightsInfo[bID].lightAmbientType));
        gl.uniform1f(lightLoc.lightDiffuseType, typeToInt(lightsInfo[bID].lightDiffuseType));
        gl.uniform1f(lightLoc.lightSpecularType, typeToInt(lightsInfo[bID].lightSpecularType));

        //gl.uniform3fv(obj.drawInfo.lightLocation.mDiffColor, lightsInfo[bID].dirColor/*materialColor*/);
        // Colors
        //gl.uniform3fv(obj.drawInfo.eyePosition, typeToInt(lightsInfo[bID].))
...
function typeToInt(type) {
    if (type == "direct" || type == "ambient" || type == "lambert" || type == "phong") {
        ...
        return 1;
    } else if (type == "spot" || type == "orenNayar" || type == "toonPhong") {
        return 2;
