...
var lights = {
    ...
    setLightValues: function (obj) {
        ...
        // Helper Variables
        var lightLoc = obj.drawInfo.lightLocation;
        console.log("lightsInfo "+lightsInfo[bID].lightType);
        console.log("lightsLoc "+lightLoc.lightType);
        ...
        dirLightTransformed = [lightsInfo[bID].pointPosX, lightsInfo[bID].pointPosY, lightsInfo[bID].pointPosZ];
        dirLightTransformed = utils.multiplyMatrix3Vector3(utils.sub3x3from4x4(viewMatrix),dirLightTransformed);;

        gl.uniform3fv(obj.drawInfo.lightLocation.pointPos,dirLightTransformed);
