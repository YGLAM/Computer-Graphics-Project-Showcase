...
var lights = {
    ...
    setLightValues: function (obj) {
        ...
        gl.uniform1f(obj.drawInfo.lightLocation.pointTarget,lightsInfo[bID].pointTarget);
        //Spot variables
        lightPosTransformed = utils.multiplyMatrixVector(viewMatrix,[lightsInfo[bID].spotPosX, lightsInfo[bID].spotPosY, lightsInfo[bID].spotPosZ, 1.0]);
