...
function keyFunction(e) {
    console.log("keycode pressed is "+ e.keyCode);
    ...
    if (!zoom) {
        ...
        switch (e.keyCode) {
            ...
            case 48:// inspect room ligthing
                ...
                showMenu("block");
                break;
            case 87: cy = cy+1;break;//W = y+
            case 83: cy = cy-1;break;//S = y-

            case 65: cx = cx-1;break;//A = x-
            case 68: cx = cx+1;break;//D = x+

            case 90: cz = cz-1;break;//Z = z-
            case 88: cz = cz+1;break;//X = x+

            case 79: angleV += 1;break;//O = fovy+
            case 76: angleV -= 1;break;//L = fovy-
            case 66: console.log("DEBUG LOG");
                     console.log("cx "+ cx+ " cy "+ cy+" cz "+ cz + " angleV "+ angleV);
                     break;
            case 82: cx = resetx;cy = resety;cz = resetz;angleV = resetAV;break;//reset view
        }
    }

    // If the view is on a model, I can only press "esc" to reset it
    else  {
        switch (e.keyCode) {
            case 27:    // Escape
                ...
                case 51:    // right
                    ...
                    break;
                case 81://evolving
                    console.log("Am I evolving");
                    easterEgg(e.keyCode);
                    break;
                case 69://shiny
                    console.log("Am I becoming shiny");
                    easterEgg(e.keyCode);
                    break
        }
    }
...
function easterEgg(keyCode){
  ...
  console.log(temp.drawInfo.name);
