  ...
  //reference is the name of an attribute
    entities.forEach(function(entity) {
        if (entity.id == activeID) {
           ...
           console.log("update Preference is doing "+ entity.drawInfo.lightLocation[attribute]);
           console.log("the new value is  "+newValue);
           entity.drawInfo.lightLocation[attribute] = newValue;
           console.log(entity.drawInfo.lightLocation[attribute]);
...
function changeSelection( type , selected, name, substring ){
  ...
  if( substring > 0){updatePreferences(name, selected.substring(substring));}
}
// Save new color
