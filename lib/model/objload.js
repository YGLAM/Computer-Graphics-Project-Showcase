...
var ol={
  initObject: async function(m_info){
        ...
        var objMod = new OBJ.Mesh(objStr);
				return new objEntity(objMod,m_info);
				//console.log("is objEnt a promise ?"+ objEnt);
				//return objEnt;
  },
  createObject:function(drawInfo){
		console.log("drawInfo is "+drawInfo);
    ...
    createIndex(gl,indexBuffer,drawInfo.indices);
		return vao;
  }
}
