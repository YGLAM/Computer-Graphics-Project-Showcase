var utils={
	...
	//Attaches shader to the program and links it
...
// manual inversion
		...
		dst = dst || new Float32Array(16);
		var zAxis = this.normalizeVector3(
			this.subtractVectors(cameraPosition, target));
		var xAxis = this.normalizeVector3(this.crossVector(up, zAxis));
		var yAxis = this.normalizeVector3(this.crossVector(zAxis, xAxis));
